...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            alipay_sign=self.env['ir.config_parameter'].sudo().get_param('alipay.alipay_sign'),
        )
        return res
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('alipay.alipay_sign', self.alipay_sign)
